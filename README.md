...
![part_1_mars_news](/Images/part_1_mars_news.png)
...
![temp_df](/Images/temp_df.png)

4. Examine the data types that are currently associated with each column. If necessary, cast (or convert) the data to the appropriate datetime, int, or float data types.

### Result

![temp_df](/Images/temo_df_changed.png)
...
![Average Minimum Temperature by Month](/Images/avg_min_tem.png)
...
![Average Pressure by Month](/Images/avg_pressure.png)
